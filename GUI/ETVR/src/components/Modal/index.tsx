                ...
                <Dialog
                    ...
                    <div class="min-h-screen px-4 flex items-center justify-center ">
                        ...
                        <TransitionChild
                            ...
                            <DialogPanel class="bg-[#292D36] inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform dark:bg-[#292D36] shadow-xl rounded-2xl  text-white">
